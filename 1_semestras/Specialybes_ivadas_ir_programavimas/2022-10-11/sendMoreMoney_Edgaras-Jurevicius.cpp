...
int main () {
    int send, more, money;
    for (int s = 1; s < 10; s++){ //pradedame nuo 1 nes priekyje nulis nerasomas
        for (int y = 0; y < 10; y++){
            for (int d = 1; d < 10; d++){ //pradedame nuo 1 nes D + E == Y, vadinasi ne 0
                for (int r = 0; r < 10; r++){
                    for (int n = 0; n < 10; n++){
                        for (int m = 1; m < 10; m++){ //pradedame nuo 1 nes priekyje nulis nerasomas
                            for (int o = 0; o < 10; o++){
                                for (int e = 1; e < 10; e++){ //pradedame nuo 1 nes D + E == Y, vadinasi ne 0
